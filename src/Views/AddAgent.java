...
public class AddAgent extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Ticket Agent");
        ...
        anew.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/an.png"))); // NOI18N
        ...
        update.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/up.png"))); // NOI18N
        ...
        del.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/del.png"))); // NOI18N
        del.setText("Delete");
    ...
    String query="INSERT INTO `agent`(`name`,`mno`,`address`,`email`,`password`) VALUES('"+jTextField2.getText()+"','"+jTextField3.getText()+"','"+jTextField4.getText()+"','"+jTextField5.getText()+"','"+jTextField6.getText()+"');";
    executeSQlQuery(query, "Inserted");
    }//GEN-LAST:event_anewActionPerformed

    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
    String query="UPDATE `agent` SET `name`='"+jTextField2.getText()+"',`mno`='"+jTextField3.getText()+"',`address`='"+jTextField4.getText()+"',`email`='"+jTextField5.getText()+"',`password`='"+jTextField6.getText()+"' WHERE `id`="+jTextField1.getText();
    executeSQlQuery(query,"Updated");
    }//GEN-LAST:event_updateActionPerformed

    private void delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delActionPerformed
      String query="DELETE FROM `agent` WHERE `id`="+jTextField1.getText();
    ...
    public ArrayList<Agent>getCashList()
    {
        ...
        try{
            ...
            while(rs.next())
            {
                agent = new Agent(rs.getInt("id"),rs.getString("name"),rs.getString("mno"),rs.getString("address"),rs.getString("email"),rs.getString("password"));
               agentList.add(agent);
            }
 ...
 // Display data in JTable
    ...
    {
        ArrayList<Agent> list=getCashList();
