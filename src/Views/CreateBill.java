...
public class CreateBill extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/7-32.png"))); // NOI18N
    ...
    private void jComboBox2PopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_jComboBox2PopupMenuWillBecomeInvisible
     ...
     String sql1="SELECT * FROM `bus` WHERE `id`=?";
     Connection con;
   ...
   ResultSet rs1;
     try{
         con=DriverManager.getConnection("jdbc:mysql://localhost:3306/bus_ticketing_system?serverTimezone=UTC", "root", "");
            ...
            if(rs1.next())
            {
                String add=rs1.getString("destination");
 ...
 public void billno()
 {
   ...
   String query="INSERT INTO `bill`(bno,`cname`,amt,`pdate`) VALUES("+jTextField1.getText()+",'"+jTextField2.getText()+"',"+jTextField7.getText()+",'"+jTextField8.getText()+"');";
       ...
       Statement st;
       try{
            con = con=DriverManager.getConnection("jdbc:mysql://localhost:3306/bus_ticketing_system?serverTimezone=UTC", "root", "");
...
//Sum of jtable
    ...
    DefaultTableModel model =(DefaultTableModel) jTable1.getModel();
                 ...
                 getsum();
                 // Update query;
                 String sql1="UPDATE `bus` SET `available`=`available` - '"+jTextField5.getText()+"' WHERE `id`='"+String.valueOf(jComboBox2.getSelectedItem())+"'";
     Connection con;
   Statement st;
  // ResultSet rs1;
     try{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            // Update query;
                 String sql1="UPDATE `bus` SET `available`=`available` + '"+jTextField5.getText()+"' WHERE `destination`='"+jTextField3.getText()+"'";
     Connection con;
   Statement st;
  // ResultSet rs1;
     try{
