...
public class AgentLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/man-user.png"))); // NOI18N
   ...
   PreparedStatement ps;
        try {
            ...
            ps=con.prepareStatement("SELECT `email`,`password` FROM `agent` WHERE `email`=? AND `password`=?;");
            ps.setString(1,jTextField1.getText());
            ps.setString(2, String.valueOf(jPasswordField1.getPassword()));
            ResultSet rs=ps.executeQuery();
            if(rs.next())
            {     
        AgentMain ca=new AgentMain();
     ca.setVisible(true);
            }else
            {
